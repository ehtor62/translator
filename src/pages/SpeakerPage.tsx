...
import { french_instructions, italian_instructions, spanish_instructions, tagalog_instructions, english_instructions, mandarin_instructions } from '../utils/translation_prompts.js';
...
export function SpeakerPage() {
  ...
  }, [french_instructions, italian_instructions,spanish_instructions, tagalog_instructions, english_instructions, mandarin_instructions]);
    ...
    <div className="speaker-page">
      ...
      <div className="card">
        <div className="card-content">
          <p>Connect to send audio in French, Italian, Spanish, English, Mandarin, and Tagalog</p>
